...
config_utilities::Factory::RegistrationRos<IDTrackerBase, DualModeTracker,
                                           std::shared_ptr<Globals>>
    DualModeTracker::registration_("dual_mode");

void DualModeTracker::Config::checkParams() const {
...
void DualModeTracker::Config::setupParamsAndPrinting() {
...
DualModeTracker::DualModeTracker(const Config& config,
...
void DualModeTracker::processInput(SubmapCollection* submaps,
                                   InputData* input) {
...
bool DualModeTracker::getLabelIfExists(const int input_id,
...
Submap* DualModeTracker::allocateSubmap(int input_id, SubmapCollection* submaps,
                                        InputData* input) {
  LabelEntry label;
...
TrackingInfoAggregator DualModeTracker::computeTrackingData(
...
TrackingInfo DualModeTracker::renderTrackingInfoApproximate(
...
TrackingInfo DualModeTracker::renderTrackingInfoVertices(
    const Submap& submap, const InputData& input) const {
