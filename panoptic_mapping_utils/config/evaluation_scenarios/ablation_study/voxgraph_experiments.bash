...
function callVoxgraph() {
    num_Args=$#
    args="play_rate:=5 use_noise:=true use_tf_transforms:=true"
    if [$num_Args -gt 0]
    then
...
function callVoxgraphSmall() {
    num_Args=$#
    args="play_rate:=1 use_noise:=true load_file:=/home/ioannis/Documents/PanopticMapping/Data/maps/flat/run1.panmap base_path:=/home/ioannis/datasets/flat_dataset/run1"
    if [$num_Args -gt 0]
    then
        args="${args} drift_type:=${1}"
    fi
...
# sleep $SLEEPTIME
# rosservice call /voxgraph_mapper/save_to_file "file_path: '/home/ioannis/datasets/voxgraph_traj_large_flat/voxgraph_traj_light.panmap'" 
...
# rosservice call /voxgraph_mapper/save_to_file "file_path: '/home/ioannis/datasets/voxgraph_traj_large_flat/voxgraph_traj_moderate.panmap'" 
# killRos


# callVoxgraph strong "false" &
# sleep $SLEEPTIME
# rosservice call /voxgraph_mapper/save_to_file "file_path: '/home/ioannis/datasets/voxgraph_traj_large_flat/voxgraph_traj_icp_off_strong.panmap'" 
...
# rosservice call /voxgraph_mapper/save_to_file "file_path: '/home/ioannis/datasets/voxgraph_traj_icp_off_severe.panmap'" 
# killRos
